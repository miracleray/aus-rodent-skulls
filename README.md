...
* **06-run-phylogenetic-analyses.Rmd** Calculates the mean specimen shape for all species. Organizes the tree, shape data, and metadata in preparation for phylogenetic analyses of shape using the 2018 Smissen & Rowe tree. Runs phylogenetic analyses including signal, evolutionary rates, phylogenetically-informed procD linear models. Plots the mean shape on a PCA with tree branches. 
