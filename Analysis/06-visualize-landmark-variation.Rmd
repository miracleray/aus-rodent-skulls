...
PC1_var_plot <- procrustes.var.plot(hypothetical_1, hypothetical_2, col = heat.colors, col.val = PC1_var$range[, "radius"], labels = F)
```

### Save plot
NOT WORKING - NEED TO SOLVE ISSUE OF 3D to 2D PLOT
```{r}
setEPS()
postscript("../Data/Results/PC1_LM_var.eps")
plot(PC1_var_plot, xlim = 400, ylim = 400, main = "Landmark variation along PC1")
dev.off()
```