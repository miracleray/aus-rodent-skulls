...
PC1.var <- variation.range(gpagen.shape, return.ID = TRUE, axis = 1, ordination = ordination, type = "spherical")
```
...
wrap_PCA <- plotTangentSpace(shape, verbose = FALSE)
...
PC1.var.plot <- procrustes.var.plot(hypothetical.1, hypothetical.2, col = heat.colors, col.val = PC1_var$range[, "radius"], labels = F)
```
