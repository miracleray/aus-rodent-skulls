...
outliers <- plotOutliers(sm.bY.shape, groups = sm.sp.info$Species, inspect.outliers = T)
```
...
out.1 <- MatchSpecShape(outliers$Zyz[1], sm.sp.info, sm.bY.shape)  # 1st outlier in genus Mel
...
med.spec <- outliers$Uro[median(outliers$Uro)]  # median specimen in Mel
