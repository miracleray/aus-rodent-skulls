...
legend(413, 0.16, legend = genus.name, col = gen.color, pch = 16, cex = 0.78)
...
legend(6.04, 0.085, legend = genus.name, col = gen.color, pch = 16, cex = 0.78)
```
...
### Test for greater disparity in _Rattus_
