...
# Flip PC1 so it makes sense in terms of larger species having larger x-values
...
save(shape, info, PCA, PCs, col.gen, file = "../Data/Processed/03-sm-data-for-analyses.rda")
```
