...
# Flip PC1 so larger species have larger x-values
...
plot(x = big.pca$pc.scores[, 1],
     ...
     cex.axis = 1.3, 
     cex.lab = 1.3)
legend(0.142, 0.095, legend = gen.name.phylo, col = col.phylo, pch = 16, cex = 0.78)
```
...
plot(x = sm.pca$pc.scores[, 1],
     ...
     cex.axis = 1.3, 
     cex.lab = 1.3)
legend(0.143, 0.101, legend = gen.name.phylo, col = col.phylo, pch = 16, cex = 0.78)
```
