...
sPC1 <- round(sm_PCs[2,1] * 100, digits = 1)
...
print(procD_s_size)
```
These ANOVAs are identical. Therefore, we decided to use only the small patch protocol as this protocol captured more information (sutures versus patch points) and had less asymmetry than the big patch protocol. It also resembles the more popular method of landmarking. 

### Save intermediate data
```{r}
save(sm_shape, sm_info, sm_PCs, sp_col.gen, file = "../Data/Results/05-sm-data-for-analyses.rda")
```